...
2. In the workflows section of your Access the environment variable through the context in each of the `run-build`, `run-tests`, and `run-command` commands of your pipeline. 
